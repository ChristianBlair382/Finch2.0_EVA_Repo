...
def search_for_corner(finch: RoomFinch):
    ...
    for _ in range(6):
        ...
        closest_points.append((dist, finch.getPosition()))
        finch.turnRight(15)
    finch.turnLeft(90)
    closest_points.sort()  # Sort by distance
    return closest_points[0][1]  # Return position of closest point
